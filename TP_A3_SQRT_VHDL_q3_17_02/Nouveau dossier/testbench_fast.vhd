...
begin
    DUT1: entity work.sqrt_fast(arch)
        generic map(n => nb_bits)
        port map(clk => CLK, RST => RST, start => start, A => A, Z_OUT => Z, done => DONE);
    
start <= '1' after 20 ns, '0' after 700ns, '1' after 1020ns, '0' after 1700ns, '1' after 2020ns, '0' after 2700ns, '1' after 3020ns, '0' after 3700ns, '1' after 4020ns, '0' after 4700ns;
